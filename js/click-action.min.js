document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchPlanetData(name) {
      ...
      if (data) {
        return {
          ...
          ringDescription: data.rings?.length ? `${data.englishName} has rings.` : `${data.englishName} does not have any rings.`,
          gravity: `Gravity: ${data.gravity || "N/A"} m/s²`,
        ...
        return { 
          ...
          ringDescription: "Ring information not available.", 
          gravity: "N/A", 
          escape: "N/A", 
          averageTemp: "N/A", 
          moons: "N/A" 
    ...
    function showInfoPanel(planetData, planetElement) {
      infoPanel.innerHTML = `
        ...
        <p>${planetData.ringDescription}</p>
